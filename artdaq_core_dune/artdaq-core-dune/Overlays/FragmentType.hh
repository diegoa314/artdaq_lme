#ifndef artdaq_dune_Overlays_FragmentType_hh
#define artdaq_dune_Overlays_FragmentType_hh
...
namespace demo
{
	 ...
	 */
	std::vector<std::string> const names{"MISSED","PRUEBA","PRUEBAV2", "TOY1", "TOY2", "UNKNOWN"};
