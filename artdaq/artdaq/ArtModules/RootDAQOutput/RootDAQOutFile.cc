...
art::RootDAQOutFile::RootDAQOutFile(OutputModule* om,
...
art::RootDAQOutFile::~RootDAQOutFile()
{
	...
	TRACE( 3,"~RootDAQOutFile free %%%u %.1fMB (%u) buffers=%fGB mem_unit=%u"
	      ,free_percent
...
void
art::RootDAQOutFile::createDatabaseTables()
{
  // Event ranges
...
void
art::RootDAQOutFile::selectProducts()
{
...
void
art::RootDAQOutFile::beginInputFile(RootFileBlock const* rfb,
...
void
art::RootDAQOutFile::respondToCloseInputFile(FileBlock const&)
{
  cet::for_all(treePointers_, [](auto const& p) { p->setEntries(); });
}

bool
art::RootDAQOutFile::requestsToCloseFile()
{
...
void
art::RootDAQOutFile::writeSubRun(SubRunPrincipal const& sr)
{
  pSubRunAux_ = &sr.aux();
...
void
art::RootDAQOutFile::writeRun(RunPrincipal const& r)
{
  pRunAux_ = &r.aux();
...
void
art::RootDAQOutFile::writeParentageRegistry()
{
...
void
art::RootDAQOutFile::writeFileFormatVersion()
{
...
void
art::RootDAQOutFile::writeFileIndex()
{
...
void
art::RootDAQOutFile::writeEventHistory()
{
  RootOutputTree::writeTTree(eventHistoryTree_);
}

void
art::RootDAQOutFile::writeProcessConfigurationRegistry()
{
...
void
art::RootDAQOutFile::writeProcessHistoryRegistry()
{
...
void
art::RootDAQOutFile::writeFileCatalogMetadata(
...
void
art::RootDAQOutFile::writeParameterSetRegistry()
{
  fhicl::ParameterSetRegistry::exportTo(rootFileDB_);
}

void
art::RootDAQOutFile::writeProductDescriptionRegistry()
{
...
void
art::RootDAQOutFile::writeProductDependencies()
{
...
void
art::RootDAQOutFile::writeResults(ResultsPrincipal& resp)
{
...
void
art::RootDAQOutFile::setSubRunAuxiliaryRangeSetID(RangeSet const& ranges)
{
...
void
art::RootDAQOutFile::setRunAuxiliaryRangeSetID(RangeSet const& ranges)
{
...
art::RootDAQOutFile::getProduct(art::OutputHandle const& oh,
